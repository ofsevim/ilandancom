  ...
  return (
    <div className="fixed inset-0 bg-navy-950/80 backdrop-blur-md flex items-center justify-center z-[100] p-4">
      <motion.div
        ...
        className="bg-navy-800 border border-silver-700/20 rounded-2xl shadow-xl max-w-md w-full overflow-hidden"
      >
        <div className="flex items-center justify-between p-6 border-b border-silver-700/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-silver-100">İletişim</h2>
        ...
        <div className="p-6 space-y-4">
          <ul className="space-y-3">
            <li className="flex items-center gap-4 p-3 bg-navy-900 border border-silver-700/10 rounded-xl">
              <div className="w-9 h-9 bg-navy-800 border border-silver-700/10 rounded-lg flex items-center justify-center text-accent">
                <span className="material-symbols-outlined text-lg">mail</span>
              </div>
              <div>
                <span className="block text-[10px] font-medium text-silver-500 uppercase tracking-wider">E-posta</span>
                <span className="text-sm font-semibold text-silver-100">omersvm0606@gmail.com</span>
              </div>
            </li>
            <li className="flex items-center gap-4 p-3 bg-navy-900 border border-silver-700/10 rounded-xl">
              <div className="w-9 h-9 bg-navy-800 border border-silver-700/10 rounded-lg flex items-center justify-center text-accent">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-silver-100">+90 312 000 00 00</span>
              </div>
            </li>
            <li className="flex items-center gap-4 p-3 bg-navy-900 border border-silver-700/10 rounded-xl">
              <div className="w-9 h-9 bg-navy-800 border border-silver-700/10 rounded-lg flex items-center justify-center text-accent">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-silver-100">Ankara, Türkiye</span>
              </div>
            </li>
          </ul>

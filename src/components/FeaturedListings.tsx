    ...
    <div className="group bg-white dark:bg-navy-900 rounded-2xl overflow-hidden border border-silver-700/10 hover:border-accent/30 transition-all duration-500 hover:shadow-card-hover">
      ...
      <div className="p-5">
        <div className="flex items-start justify-between mb-3">
          <div className="text-xl font-black text-accent tracking-tight">
            {listing.price.toLocaleString('tr-TR')} ₺
          </div>
          <div className="flex items-center gap-1 text-[11px] font-bold text-silver-600 uppercase tracking-widest">
        ...
        <div className="flex items-center gap-2 text-xs font-bold text-silver-400 mb-5">
  ...
  return (
    <section className="mt-12 bg-white dark:bg-navy-950 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link
          to="/ilanlar"
          className="text-accent font-bold flex items-center gap-1 hover:underline group"
        >
          Tümünü Gör
